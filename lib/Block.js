...
var BlockRules = {
  maxTimeOffset: 2 * 60, // How far block timestamps can be into the future
...
Block.getBlockValue = function getBlockValue(height) {
  ...
  if (height > 5450)
      subsidy = 12.5 * util.COIN;

  if (height == 1)
      subsidy = 10500000 * util.COIN;

  subsidy = subsidy / (Math.pow(2, Math.floor(height / 417000)));
